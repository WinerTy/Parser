...
/format: Отформатировать файл и определить категории и подкатегории товаров. Вместе с командой отправить файл excel. При фоматировании файла все записи в Базе Данных будут обновляться, если запись есть в БД, но ее нет в файле она становится не активной(Не будет вложена и обновлена в итоговый результат)
...
/update: Обновление данных в Базе Данных, используется вместе с файлом.
/get: Получение всех записей из Базы Данных.
